...
<body>
    <div class="yumeramenmaindiv">
        ...
        <div class="container mt-5">
                        ...
                        <tbody>
                            <?php foreach ($producten as $product) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../update/index.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="../delete/index.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Zeker?')">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="mt-3">
                <a href="../create/index.php" class="btn btn-salmon">Nieuw Product</a>
            </div>
        </div>
    </div>
