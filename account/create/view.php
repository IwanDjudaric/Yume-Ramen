...
<head>
    ...
    <title>Product Toevoegen - Yume Ramen</title>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title text-center mb-4">Product Toevoegen</h2>
                            ...
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="categorie_id" name="categorie_id" required>
                                        ...
                                        <?php foreach ($categories as $cat) { ?>
                                            <option value="<?php echo $cat['id']; ?>" <?php echo isset($categorie_id) && $categorie_id == $cat['id'] ? 'selected' : ''; ?>>
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-salmon">Toevoegen</button>
                                </div>
                            </form>
                        </div>
                    </div>
